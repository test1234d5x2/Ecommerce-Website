        ...
        return (
            <footer>
                <section className="footer-section">
                    ...
                    <a className="footer-link" onClick={(event) => {this.props.changeTypeFilter("NEW!")}}>NEW!</a>
                    <a className="footer-link" onClick={(event) => {this.props.changeTypeFilter("Collections")}}>Collections</a>
                    <a className="footer-link" onClick={(event) => {this.props.changeTypeFilter("Shirts")}}>Shirts</a>
                    <a className="footer-link" onClick={(event) => {this.props.changeTypeFilter("Polo Shirts")}}>Polo Shirts</a>
                    <a className="footer-link" onClick={(event) => {this.props.changeTypeFilter("Formal")}}>Formal</a>
                </section>
                <section className="footer-section">
